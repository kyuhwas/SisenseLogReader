...
public class MicroServicesLogParser implements ILogParser {
    ...
    public MicroServicesLogParser(List<String> logLines, Date start, Date end, String microservice){
        this.logs = new ArrayList<>();
        parse(logLines, start, end, microservice);
    }

    private void parse(List<String> logLines, Date start, Date end, String microservice) {
